...
import manageBook from "../assets/literature_8759946.png"
...
<aside id="separator-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   ...
   <a href="/" class="flex items-center ps-2.5 mb-5">
         ...
         <PiUserCircleGearDuotone className='w-8 h-8'/>
         <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white mx-2">Mahesh</span>
      </a>
      ...
      <ul class="space-y-2 font-medium">
         ...
         <li>
            ...
            <IoCloudUploadSharp className='w-5 h-5'/>
         ...
         <li>
            <a href="/admin/dashboard/manage" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <img src={manageBook} alt="" className='w-6 h-6' />
