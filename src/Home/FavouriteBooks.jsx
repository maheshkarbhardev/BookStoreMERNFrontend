...
import FavBookImg from "../assets/book-3.jpg"
  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center '>
        ...
        <div className='md:w-1/2 space-y-6'>
            ...
            <p className='mb-10 text-lg md:w-5/6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed, ipsum nesciunt accusamus officia voluptates maxime quia pariatur eum qui laboriosam aliquid. Maxime incidunt commodi dicta enim ea iusto architecto suscipit!</p>
